...
const copy = {
  en: {
    ...
    'analysis.description': 'ARIA checks structured merchant events, runs its calculation in a protected sandbox, and returns only the result.',
    ...
    'analysis.resultHeading': 'Analysis result',
    'analysis.boundary': 'Protected sandbox · No host access · 128 MB · 5 seconds',
    'analysis.result': 'Answer',
    'analysis.complete': 'ARIA completed the structured analysis.',
    'analysis.unknownResult': 'ARIA completed the calculation. View the structured result below for the full detail.',
    'analysis.noMatchingResults': 'ARIA did not find a matching result.',
    'analysis.resultsFound': ({ count }) => `ARIA found ${count} ${count === 1 ? 'matching result' : 'matching results'}.`,
    'analysis.customersFound': ({ count }) => `ARIA found ${count} ${count === 1 ? 'matching customer' : 'matching customers'}.`,
    'analysis.overview': 'Overview',
    'analysis.results': 'Results',
    'analysis.customerResults': 'Customer results',
    'analysis.customer': ({ index }) => `Customer ${index}`,
    'analysis.resultItem': ({ index }) => `Result ${index}`,
    'analysis.value': 'Value',
    'analysis.notAvailable': 'Not available',
    'analysis.yes': 'Yes',
    'analysis.no': 'No',
    'analysis.dayCount': ({ count }) => `${count} days`,
    'analysis.moreResults': ({ count }) => `${count} additional ${count === 1 ? 'result is' : 'results are'} available in the structured detail.`,
    'analysis.structuredDetails': 'View structured details',
    'analysis.field.customer': 'Customer',
    'analysis.field.lastPurchase': 'Last purchase',
    'analysis.field.daysQuiet': 'Days quiet',
    'analysis.field.typicalPurchaseInterval': 'Typical purchase interval',
    ...
    'error.rateLimitBrief': 'Please wait a minute before refreshing the ARIA brief again.',
    ...
    'error.aiRequestRejected': 'The AI service rejected ARIA\'s request. The operator should check the provider configuration.',
    'error.aiProvidersUnavailable': 'Both configured AI services are temporarily unavailable. Please try again shortly.',
  ...
  pg: {
    ...
    'analysis.eyebrow': 'CODEX ANALYSIS AGENT',
    'analysis.description': 'ARIA dey check structured merchant event, run calculation inside protected sandbox, then return only the result.',
    ...
    'analysis.boundary': 'Protected sandbox · No host access · 128 MB · 5 seconds',
    'analysis.result': 'Answer',
    'analysis.complete': 'ARIA don complete the structured analysis.',
    'analysis.unknownResult': 'ARIA don complete the calculation. See the structured result below for full detail.',
    'analysis.noMatchingResults': 'ARIA no find matching result.',
    'analysis.resultsFound': ({ count }) => `ARIA find ${count} matching ${count === 1 ? 'result' : 'result dem'}.`,
    'analysis.customersFound': ({ count }) => `ARIA find ${count} matching ${count === 1 ? 'customer' : 'customer dem'}.`,
    'analysis.overview': 'Main point',
    'analysis.results': 'Result dem',
    'analysis.customerResults': 'Customer result',
    'analysis.customer': ({ index }) => `Customer ${index}`,
    'analysis.resultItem': ({ index }) => `Result ${index}`,
    'analysis.value': 'Value',
    'analysis.notAvailable': 'No dey available',
    'analysis.yes': 'Yes',
    'analysis.no': 'No',
    'analysis.dayCount': ({ count }) => `${count} days`,
    'analysis.moreResults': ({ count }) => `${count} more ${count === 1 ? 'result dey' : 'result dem dey'} for structured detail.`,
    'analysis.structuredDetails': 'See structured details',
    'analysis.field.customer': 'Customer',
    'analysis.field.lastPurchase': 'Last purchase',
    'analysis.field.daysQuiet': 'Days wey customer quiet',
    'analysis.field.typicalPurchaseInterval': 'Normal buying interval',
    'agent.eyebrow': 'CONTROL ROOM',
    ...
    'error.rateLimitBrief': 'Abeg wait one minute before you refresh ARIA brief again.',
    ...
    'error.aiRequestRejected': 'The AI service reject ARIA request. Person wey manage am need check the provider configuration.',
    'error.aiProvidersUnavailable': 'Both configured AI services no dey available now. Abeg try again soon.',
